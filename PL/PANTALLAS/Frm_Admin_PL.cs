...
{
    public partial class Frm_Admin_PL : Form
    {
        ...
        {
            Frm_Pacientes pantalla = new Frm_Pacientes();
            pantalla.ShowDialog();
        }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            PANTALLAS.Frm_Modificar_Pacientes_PL Pacientes = new Frm_Modificar_Pacientes_PL();
        ...
        //        Cls_Casos_BLL Obj_Casos_BLL = new Cls_Casos_BLL();

        //        DataSet DS = new DataSet();

        //        Obj_Casos_BLL.ListarFiltrarTodos(ref DS, txtFiltro.Text.Trim());

        //        if (DS != null)
        //        {

        //            dgv_Casos.DataSource = null;
        //            dgv_Casos.DataSource = DS.Tables[0];
        //        }
