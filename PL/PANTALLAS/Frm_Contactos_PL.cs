...
{
    public partial class Frm_Contactos_PL : Form
    {
        ...
        {
            Frm_Crear_Contactos_PL pantalla = new Frm_Crear_Contactos_PL();
            pantalla.ShowDialog();
        }
        ...
        {
            Frm_Modificar_Familiares_PL Familiares = new Frm_Modificar_Familiares_PL();
